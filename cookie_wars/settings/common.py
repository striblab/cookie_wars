"""
Django settings for cookie_wars project.
...
SECRET_KEY = '#1(t2ddc(s-8du!5rh8xbwfz!houu#t%k^vj(pd1b7-3ij!xip'
...
WSGI_APPLICATION = 'cookie_wars.wsgi.application'
